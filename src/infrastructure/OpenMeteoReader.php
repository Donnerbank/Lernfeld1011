...
class OpenMeteoReader
{
    ...
    // https://api.open-meteo.com/v1/forecast?latitude=53.5507&longitude=9.993&hourly=temperature_2m,weathercode,cloudcover,uv_index,uv_index_clear_sky,terrestrial_radiation,terrestrial_radiation_instant&current_weather=true&timezone=Europe/Berlin&forecast_days=1
